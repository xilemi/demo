        ...
        <div>
            {
                list.map((item, index) => {
                    return (
                        <div key={item.commentid} className='movein' ref={el => itemRef.current[item.commentid] = el} style={{ width: "60%", background: "pink", marginTop: 20, borderRadius: 10, animationDelay: 100 * index + 'ms' }}>
